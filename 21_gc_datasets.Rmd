...
NB: Most databases from Statistics Canada site can be accessed using `cansim` package like in this code `dt <- cansim::get_cansim("13-10-0810-01")  %>% data.table::setDT(dt)`.
Most other dataset can be access via direct link to an .csv, .zip,  xls file
