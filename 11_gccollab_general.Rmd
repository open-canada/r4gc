...
R integrates well with Python and other free and commercial Data Science tools. It can also do something that other tools cannot and is very well  supported by growing international community. I
...
Below are our own top 10 reasons to use R for Data Science - filtered and refined over the past two years by the members of this community, with links. 
...
Operations Research
EEE Transactions on Cybernetics (formerly "IEEE Transactions on Systems Man and Cybernetics Part C (Applications and Reviews)")
